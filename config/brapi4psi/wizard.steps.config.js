window.steps = [
    ...
    },
    {
        hooks: [
            {
                ...
                parameters: {
                    ...
                    protocolType: {
                        "@id": "",
                        "annotationValue": "stratification growth protocol",
                        "termSource": "DPBO",
        ...
        component: "protocol",
        jsonPath: 'studies[0].protocols[0]',
        componentConfig: {
            showComments: false,
            label: 'Protocols'
        }
    },
    {
        hooks: [
            {
                ...
                parameters: {
                    ...
                    protocolType: {
                        "@id": "",
                        "annotationValue": "germination growth protocol",
                        "termSource": "DPBO",
                        "termAccession": "DPBO:1000164",
                        "comments": []
                    },
        ...
        component: "protocol",
        jsonPath: 'studies[0].protocols[1]',
        componentConfig: {
            showComments: false,
            label: 'Protocols'
        }
    ...
    },
    {
        ...
        component: "protocol",
        jsonPath: 'studies[0].protocols[2]',
        componentConfig: {
            showComments: false,
            label: 'Protocols'
        }
